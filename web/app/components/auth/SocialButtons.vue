...
// Sign-in and registration pages carry ?redirect (e.g. from checkout), and a
// Google sign-in has to honour it the same way the password form does.
...
<template>
  <div v-if="hasAny" class="space-y-3">
    ...
    <button v-if="has('google')" type="button" :class="buttonClass" @click="signInWith('google', redirect)">
